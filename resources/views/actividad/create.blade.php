            ...
            <div class="box box-success">
                ...
                <meta name="_token" content="{!! csrf_token() !!}"/>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                            {!! Field::text('nombre', ['class'=>'form-control', 'placeholder'=>'Ingrese nombre de actividad', 'value'=>'old(nombre)'])!!}
                        </div> <!-- form-group -->
                      </div> <!-- col-md-12 -->
                    </div> <!-- row -->
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <br>
                            <!-- Table row -->
                                    <div class="col-lg-12 col-md-8 col-sm-8 col-xs-12 table-resposive">
                                        <table id="planes" name="planes" class="table table-bordered table-condensed table-hover text-center">
                                            <thead>
                                                <th>Id</th>
                    ...
                    <div class="row" align="center">
                        <div class="form-group">
                            <button class="btn btn-primary" type="submit" id="btn1" name="btn1">Guardar</button>
                ...
                <script>
                    ...
                    $("#btn1").click(function (e) {
                        ...
                        if (b){
                            ...
                            alert("Error al guardar una actividad, no debe haber planes repetidos");
                        }
                    ...
                    $('#btn_add').on('click',function(){
                        ...
                        function actividad_planes(){
                            ...
                            precio=$("#precio").val();
                            if(plan!='-'&& precio!=""){
                                var fila = '<tr class="select" id="fila'+cont+'"> <td> <input readonly type="hidden" name="idplan[]" value="'+idplan+'">'+idplan+'</td> <td><input type="hidden" name="plan[]" value="'+plan+'">'+plan+'</td> <td><input align="center" style="border:none" type="hidden" name="cantidad[]" value="'+cantidad+'">'+cantidad+'</td> <td>$<input readonly style="border:none; width:30%;" type="number" id="precio[]" name="precio[]" value="'+precio+'"></td> <td><button id="btn_eliminar" name="btn_eliminar" type="button" class="btn btn-danger" onclick="eliminar('+cont+')">X</button></td></tr>';
                                cont++;
                                $("#planes").append(fila);
                                limpiar();
                            }
